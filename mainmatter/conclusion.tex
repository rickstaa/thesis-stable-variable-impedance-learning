...
% TODO: Check calafoni discussion: Passivity is required! Tradeoff, Safety ect. Stability does not imply safety! Tanks can be used when safety or performance is more important than stability.
...
% Collosion ovoidance not desired in all tasks when interaction is needed. The full robot design is therefore taks dependent.
