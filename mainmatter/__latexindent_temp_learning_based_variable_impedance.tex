...
% NOTE: -- TOT HIER NAGEKEKEN --

% [ ] Check anand review.

% = DIFFEOMORPIC PAPERS =
% [ ]: Diffeomorphic papers.
%     [ ]: Ordered papers.
%     [ ]: Find pros and cons.
%     [ ]: Check references.
%     [ ]: Check if diffeomorphisms can be used with any regression technique.
% [ ]: Check Zhang et al. 2022
% [ ]: Local stability Dutta 2021 add comment to text?
% [ ]: Check Duan 2019 remarks on neuman.
% [ ]: Check Jin et al. 2019 dimension ascent.
% [ ]: Check billart 2022.
% [ ]: Saveriano gives good overview of diffeomorpic methods before 2022.
...
% = CONTRACTION PAPERS =.
% [ ]: Check if cons and pros are explained correctly.
% [ ]: Check references.
%   [ ]: Rana and Urain 2020 remarks on convergence.
...
% = OTHER =
% [ ]: Double check Figueroa et al. 2022.
